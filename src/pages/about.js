  ...
  return (
    <>
        <Head>
            ...
            <meta name='description' content="about descr"/>
        </Head>
                ...
                <div className='grid w-full grid-cols-8 gap 16'>
                    <div className='col-span-3 flex flex-col items-start justify-start'>
                        ...
                        <p className='font-medium pr-8'>
                            - Hi, Im Andrii Balan, a web developer with a passion for creating beautiful, functional, 
                    ...
                    bg-light p-8 flex justify-center'>
                        <div className='absolute top-0 -right-3 -z-10 w-[102%] h-[102%] rounded-[2rem] bg-dark'/>
                        <Image src={profilePic} alt="Andrii Balan" className="w-[90%] h-auto rounded-2xl"/>
                    </div>
