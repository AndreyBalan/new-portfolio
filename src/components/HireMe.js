...
const HireMe = () => {
    return (
        <div className="fixed left-4 bottom-20 flex items-center justify-center overflow-hidden md:absolute md:right-4 md:left-auto md:top-0 md:bottom-auto">
            ...
            shadow-md border border-solid border-dark w-20 h-20 rounded-full font-semibold hover:bg-light hover:text-dark dark:bg-light dark:text-dark hover:dark:bg-dark hover:dark:text-light hover:dark:border-light transition-all duration-300 ease-out md:w-12 md:text-[10px] md:h-12 z-20">
                    Hire Me
                </Link>
            </div>
        </div>
